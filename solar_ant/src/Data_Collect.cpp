...
void csv_Init()
{
	std::ofstream 
	    ...
	    LM35f_1("/home/ubuntu/catkin_ws/src/solar_ant/Data/LM35_1_Data.csv"),	
		LM35f_2("/home/ubuntu/catkin_ws/src/solar_ant/Data/LM35_2_Data.csv"),	
		GPSf("/home/ubuntu/catkin_ws/src/solar_ant/Data/GPS_Data.csv"),
		Motorf("/home/ubuntu/catkin_ws/src/solar_ant/Data/VR_motor_Data.csv"),
		Brushf("/home/ubuntu/catkin_ws/src/solar_ant/Data/VL_motor_Data.csv");
...
void LM35_1_Collect(const std_msgs::String::ConstPtr& msg)
{
        char* time;
        time = Data_time();
        ROS_INFO("I heard: [%s]", msg->data.c_str());
        write_csv("/home/ubuntu/catkin_ws/src/solar_ant/Data/LM35_1_Data.csv", time, msg);
}

void LM35_2_Collect(const std_msgs::String::ConstPtr& msg)
{
        char* time;
        time = Data_time();
        ROS_INFO("I heard: [%s]", msg->data.c_str());
        write_csv("/home/ubuntu/catkin_ws/src/solar_ant/Data/LM35_2_Data.csv", time, msg);
}
...
void Motor_Collect(const std_msgs::String::ConstPtr& msg)
{
	char* time;
        time = Data_time();
        write_csv("/home/ubuntu/catkin_ws/src/solar_ant/Data/VR_motor_Data.csv", time, msg);
}
...
void Brush_Collect(const std_msgs::String::ConstPtr& msg)
{
	char* time;
        time = Data_time();
        write_csv("/home/ubuntu/catkin_ws/src/solar_ant/Data/VL_motor_Data.csv", time, msg);
}
...
int main(int argc, char **argv)
{
	...
	ros::Subscriber LM35_1_sub = n.subscribe("LM35_1", 1000, LM35_1_Collect);
	ros::Subscriber LM35_2_sub = n.subscribe("LM35_2", 1000, LM35_2_Collect);
	ros::Subscriber GPS_sub = n.subscribe("GPS", 1000, GPS_Collect);
	ros::Subscriber Motor_sub = n.subscribe("VR", 1000, Motor_Collect);
	ros::Subscriber Brush_sub = n.subscribe("VL", 1000, Brush_Collect);
